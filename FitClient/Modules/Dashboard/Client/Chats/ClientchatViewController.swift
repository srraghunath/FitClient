...
//        DataService.shared.loadChat(forClientId: "client_001") { [weak self] result in
//            guard let self = self else { return }
//            switch result {
//            case .success(let chatData):
//                self.messages = chatData.messages.sorted { $0.timestamp < $1.timestamp }
...
//                randomResponse = "I'll get back to you."
//            }
//            
//            let trainerMessage = Message(
//                id: "msg_\(UUID().uuidString.prefix(8))",
//                senderId: "trainer_001",
//                senderName: "Alex Fitness",
...
// MARK: - Chat Message Model is now in Common/Models/Message.swift
